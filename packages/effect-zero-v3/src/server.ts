...
export type ServerOverrideResult<TServices = unknown> = ServerEffectMutatorResult<TServices>;
...
export type TypedDefineServerMutator<
  TSchema extends ZeroSchema,
  TContext,
  TWrappedTransaction,
> = ReturnType<typeof defineMutatorWithType<TSchema, TContext, TWrappedTransaction>>;
...
>(): TypedDefineServerMutator<TSchema, TContext, TWrappedTransaction> {
  return defineMutatorWithType<TSchema, TContext, TWrappedTransaction>();
}
...
>(
  ...
  override: ExtendServerMutatorOverride<TOutput, TSchema, TContext, TWrappedTransaction, TServices>,
